...
import { addTransparency } from './palette'
...
const PRIMARY = `0 8px 16px 0 ${addTransparency(
  Palette.light.primary.main,
  0.24
)}`
const INFO = `0 8px 16px 0 ${addTransparency(Palette.light.info.main, 0.24)}`
const SUCCESS = `0 8px 16px 0 ${addTransparency(
  Palette.light.success.main,
  0.24
)}`
const WARNING = `0 8px 16px 0 ${addTransparency(
  Palette.light.warning.main,
  0.24
)}`
const ERROR = `0 8px 16px 0 ${addTransparency(Palette.light.error.main, 0.24)}`

const onLight1 = addTransparency(BASE_LIGHT, 0.2)
const onLight2 = addTransparency(BASE_LIGHT, 0.14)
const onLight3 = addTransparency(BASE_LIGHT, 0.12)

const onDark1 = addTransparency(BASE_DARK, 0.2)
const onDark2 = addTransparency(BASE_DARK, 0.14)
const onDark3 = addTransparency(BASE_DARK, 0.12)
...
const Shadows = {
  light: [
    ...
    // Custom
    {
      z1: `0 1px 2px 0 ${addTransparency(BASE_LIGHT, 0.24)}`,
      z8: `0 8px 16px 0 ${addTransparency(BASE_LIGHT, 0.24)}`,
      z12: `0 0 2px 0 ${addTransparency(
        BASE_LIGHT,
        0.24
      )}, 0 12px 24px 0 ${addTransparency(BASE_LIGHT, 0.24)}`,
      z16: `0 0 2px 0 ${addTransparency(
        BASE_LIGHT,
        0.24
      )}, 0 16px 32px -4px ${addTransparency(BASE_LIGHT, 0.24)}`,
      z20: `0 0 2px 0 ${addTransparency(
        BASE_LIGHT,
        0.24
      )}, 0 20px 40px -4px ${addTransparency(BASE_LIGHT, 0.24)}`,
      z24: `0 0 4px 0 ${addTransparency(
        BASE_LIGHT,
        0.24
      )}, 0 24px 48px 0 ${addTransparency(BASE_LIGHT, 0.24)}`,
      primary: PRIMARY,
      info: INFO,
      success: SUCCESS,
      warning: WARNING,
  ...
  dark: [
    ...
    // Custums
    {
      z1: `0 1px 2px 0 ${addTransparency(BASE_DARK, 0.24)}`,
      z8: `0 8px 16px 0 ${addTransparency(BASE_DARK, 0.24)}`,
      z12: `0 0 2px 0 ${addTransparency(
        BASE_DARK,
        0.24
      )}, 0 12px 24px 0 ${addTransparency(BASE_DARK, 0.24)}`,
      z16: `0 0 2px 0 ${addTransparency(
        BASE_DARK,
        0.24
      )}, 0 16px 32px -4px ${addTransparency(BASE_DARK, 0.24)}`,
      z20: `0 0 2px 0 ${addTransparency(
        BASE_DARK,
        0.24
      )}, 0 20px 40px -4px ${addTransparency(BASE_DARK, 0.24)}`,
      z24: `0 0 4px 0 ${addTransparency(
        BASE_DARK,
        0.24
      )}, 0 24px 48px 0 ${addTransparency(BASE_DARK, 0.24)}`,
      primary: PRIMARY,
      info: INFO,
      success: SUCCESS,
      warning: WARNING,
